...
// Fuzzy line line intersection is almost twice as slow so leave the regular
// for when user knows they aren't parallel. Since equality with floating point
// numbers is rare is there even a point of checking exact equality, or just
// let it return infinite numbers.
...
func Intersection2DLineLine(a, b *Line2D, z *Vector2D) int {
	...
	if d == 0 {
		...
		if a.P1.Y-am*a.P1.X == b.P1.Y-bm*b.P1.X {
			return -1
		}
		return 0
	}
